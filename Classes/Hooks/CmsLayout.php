...
class CmsLayout {
	...
	protected function getVideosByContentUid($uid) {
		return $this->getDatabaseConnection()
			->exec_SELECTgetRows('tx_html5videoplayer_domain_model_video.*', 'tx_html5videoplayer_domain_model_video,tx_html5videoplayer_video_content', 'tx_html5videoplayer_domain_model_video.uid = tx_html5videoplayer_video_content.video_uid AND tx_html5videoplayer_domain_model_video.deleted=0 AND tx_html5videoplayer_video_content.content_uid=' . (int)$uid, '', 'tx_html5videoplayer_video_content.sorting');
	}
